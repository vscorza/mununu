...
**Scope:** lift the `ConnectionSpec` + composition-emission code out of the custom-SV path into a shared helper both frontends call. The custom-SV path's port-binding logic in [annotation.rs:1060-1122](../../crates/mununu-core/src/adapter/systemverilog/annotation.rs#L1060-L1122) becomes the canonical implementation; yosys's new black-box-aware path calls into it.
