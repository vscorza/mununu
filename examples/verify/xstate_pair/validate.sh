#!/usr/bin/env bash
# validate.sh — end-to-end smoke test for the xstate_pair example.
#
...
DIR="examples/verify/xstate_pair"
...
{
    printf '# xstate_pair — verify framework end-to-end transcript\n'
    printf '# Regenerated via examples/verify/xstate_pair/validate.sh\n'
    printf '#\n'
    printf '# Two XState machines composed asynchronously; direct alphabet\n'
    printf '# binding (no renaming); two properties (template-sourced\n'
    printf '# no_deadlock + inline `true`).\n\n'
