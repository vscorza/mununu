...
use mununu::adapter::systemverilog::SystemVerilogAdapter;
use mununu::adapter::systemverilog::emit_controller::{
...
fn sv_traffic_light_cross_validate_ctxdsl() {
    ...
    let ctxdsl_source =
        std::fs::read_to_string("examples/hw/traffic_light.ctxdsl").expect("traffic_light.ctxdsl");
