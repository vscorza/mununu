...
- [`docs/api-schemas/verdict.md`](docs/api-schemas/verdict.md) — Stable JSON schema for `PropertyVerdict` / `SvVerifyAutoResponse` / `PropertyVerdictView` / counterexample shapes; the wire-format contract downstream consumers (ROSF, monono) should code against.
