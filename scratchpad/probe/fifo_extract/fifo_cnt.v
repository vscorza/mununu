module prim_fifo_sync_cnt (
	...
	wire wptr_wrap_set;
	wire rptr_wrap_set;
	function automatic [PtrW - 1:0] sv2v_cast_5F322;
		input reg [PtrW - 1:0] inp;
		sv2v_cast_5F322 = inp;
	endfunction
	assign wptr_wrap_set = incr_wptr_i & (wptr_o == sv2v_cast_5F322(Depth - 1));
	assign rptr_wrap_set = incr_rptr_i & (rptr_o == sv2v_cast_5F322(Depth - 1));
	...
	function automatic [DepthW - 1:0] sv2v_cast_A7A17;
		input reg [DepthW - 1:0] inp;
		sv2v_cast_A7A17 = inp;
	endfunction
	assign depth_o = (full_o ? sv2v_cast_A7A17(Depth) : (wptr_wrap_msb == rptr_wrap_msb ? sv2v_cast_A7A17(wptr_o) - sv2v_cast_A7A17(rptr_o) : (sv2v_cast_A7A17(Depth) - sv2v_cast_A7A17(rptr_o)) + sv2v_cast_A7A17(wptr_o)));
	function automatic [WrapPtrW - 1:0] sv2v_cast_BA82A;
