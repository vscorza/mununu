...
// @mununu_guarantee nu Z. ((spiCS_n == 1 || spiTransSts == 1) and [] Z)
// @mununu_guarantee nu Z. (((SDInitReq == 0 || txDataWen == 0) && (SDInitReq == 0 || readWriteSDBlockReq == 0) && (txDataWen == 0 || readWriteSDBlockReq == 0)) and [] Z)
endmodule
